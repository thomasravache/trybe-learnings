...
const books_1 = __importDefault(require("../enums/books"));
...
router.get('/books', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return res.status(books_1.default.OK).json(books);
}));
router.get('/books/:isbn', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!book)
        return res.status(books_1.default.NOT_FOUND).json({ message: NotFoundMessage });
    return res.status(books_1.default.OK).json(book);
}));
router.post('/books', validationBook_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return res.status(books_1.default.CREATED).json(book);
}));
router.put('/books/:isbn', validationBook_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (bookIndex === -1)
        return res.status(books_1.default.NOT_FOUND).send(NotFoundMessage);
    books.splice(bookIndex, 1, editedBook);
    yield (0, functions_1.write)(books);
    return res.status(books_1.default.OK).json(editedBook);
}));
router.delete('/books/:isbn', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (bookIndex === -1)
        return res.status(books_1.default.NOT_FOUND).send(NotFoundMessage);
    const actualizatedBooks = books.filter((book) => book.isbn !== isbn);
    yield (0, functions_1.write)(actualizatedBooks);
    return res.status(books_1.default.NO_CONTENT).end();
}));
